            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
              <div class="card-body">
                      <div class="list-group">
                        <a href="<?php echo URL."dashboard/dashboard.php?menu=kategori&action=list"; ?>" class="list-group-item">Kategori</a>
                        <a href="<?php echo URL."dashboard/dashboard.php?menu=barang&action=list"; ?>"" class="list-group-item">Barang</a>
