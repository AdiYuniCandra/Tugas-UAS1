 ...
 <!-- Search Widget -->
	...
	<a class="btn btn-outline-primary" href="<?php echo URL."dashboard/dashboard.php?menu=barang&action=form" ?>">+</a>
	</div>
<?php 
...
<a href='' class='text-primary' data-toggle='modal' data-target='#$row[barang_id]'>
  Lihat Gambar
</a>
      ...
      <div class='modal-body'>
       <img src='".URL."img/barang/$row[gambar_barang]' class='img-fluid'>
		          				...
		          				<td class='text-center'>
	                                 ...
	                                 <a class='btn btn-outline-primary btn-sm' href='".URL."dashboard/dashboard.php?menu=barang&action=form&barang_id=$row[barang_id]' role='button'><img src='".URL."img/edit1.png' class='rounded' style='width:20px;height:20px;'></a>
	                                </p>

	                                <p class='d-inline-flex'>
	                                 <a class='btn btn-outline-primary btn-sm' href='".URL."dashboard/barang/action.php?button=delete&barang_id=$row[barang_id]' role='button'><img src='".URL."img/hapus.jpg' class='rounded' style='width:20px;height:20px;'></a>
	                                </p>
