 <center><b>DATA SLIDE</b></center>
   <div class="mb-2 mt-3">
	<a class="btn btn-outline-primary" href="<?php echo URL."dashboard/dashboard.php?menu=slide&action=form" ?>">+</a>
	</div>
<?php 
...
<a href='' class='text-primary' data-toggle='modal' data-target='#$row[slide_id]'>
  Lihat Gambar
</a>
      ...
      <div class='modal-body'>
       <img src='".URL."img/slide/$row[gambar_slide]' class='img-fluid'>
		          				...
		          				<td class='text-center'>
	                                 ...
	                                 <a class='btn btn-outline-primary btn-sm' href='".URL."dashboard/dashboard.php?menu=slide&action=form&slide_id=$row[slide_id]' role='button'><img src='".URL."img/edit1.png' class='rounded' style='width:20px;height:20px;'></a>
	                                </p>

	                                <p class='d-inline-flex'>
	                                 <a class='btn btn-outline-primary btn-sm' href='".URL."dashboard/slide/action.php?button=delete&slide_id=$row[slide_id]' role='button'><img src='".URL."img/hapus.jpg' class='rounded' style='width:20px;height:20px;'></a>
	                                </p>
